...
for div = 5:5
    ...
    A = [ 
          ...
          sparse(m,m)                       ,  sparse(m,m)                      ,  sSE.T{4,1}                      ,  sSE.T{4,4}                       ,  sparse(m,m)                     , sparse(m,m)                      ,  sparse(m,m)                     ,  speye(m)                         ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  0.5*sSE.T{4,5}(:,1)                 ,  sSE.T{4,5}(:,3)                       ,  0.5*sSE.T{4,5}(:,4)                  ,  sparse(m,1)                          ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                         ;
          sparse(m,m)                       ,  sparse(m,m)                      ,  sparse(m,m)                     ,  sparse(m,m)                      ,  sNW.T{2,2}                      , sNW.T{2,3}                       ,  speye(m)                        ,  sparse(m,m)                      ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  0.5*sNW.T{2,5}(:,1)                  ,  sNW.T{2,5}(:,2)                       ,  0.5*sNW.T{2,5}(:,4)                  ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                         ;
          sparse(m,m)                       ,  speye(m)                         ,  sparse(m,m)                     ,  sparse(m,m)                      ,  sNW.T{3,2}                      , sNW.T{3,3}                       ,  sparse(m,m)                     ,  sparse(m,m)                      ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  0.5*sNW.T{3,5}(:,1)                  ,  sNW.T{3,5}(:,2)                       ,  0.5*sNW.T{3,5}(:,4)                  ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                         ;
          sparse(m,m)                       ,  sparse(m,m)                      ,  sparse(m,m)                     ,  sparse(m,m)                      ,  speye(m)                        , sparse(m,m)                      ,  sNE.T{1,1}                      ,  sNE.T{1,3}                       ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                          ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sNE.T{1,5}(:,1)                       ,  0.5*sNE.T{1,5}(:,2)                  ,  0.5*sNE.T{1,5}(:,3)                 ;
          sparse(m,m)                       ,  sparse(m,m)                      ,  sparse(m,m)                     ,  speye(m)                         ,  sparse(m,m)                     , sparse(m,m)                      ,  sNE.T{3,1}                      ,  sNE.T{3,3}                       ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                         ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sparse(m,1)                          ,  sparse(m,1)                           ,  sparse(m,1)                          ,  sNE.T{3,5}(:,1)                       ,  0.5*sNE.T{3,5}(:,2)                  ,  0.5*sNE.T{3,5}(:,3)                 ;
          sSW.T{5,2}(2,:)                   ,  sSW.T{5,4}(2,:)                  ,  sparse(1,m)                     ,  sparse(1,m)                      ,  sparse(1,m)                     , sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  0.5*sSW.T{5,5}(2,2)+0.5             ,  0.5*sSW.T{5,5}(2,3)                   ,  sSW.T{5,5}(2,4)                      ,  1                                   ,  0                                     ,  0                                    ,  0                                    ,  0                                     ,  0                                    ,  0                                     ,  0                                    ,  0                                   ;
          sSW.T{5,2}(3,:)                   ,  sSW.T{5,4}(3,:)                  ,  sparse(1,m)                     ,  sparse(1,m)                      ,  sparse(1,m)                     , sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  0.5*sSW.T{5,5}(3,2)                 ,  0.5*sSW.T{5,5}(3,3)+0.5               ,  sSW.T{5,5}(3,4)                      ,  0                                   ,  0                                     ,  0                                    ,  1                                    ,  0                                     ,  0                                    ,  0                                     ,  0                                    ,  0                                   ;
          -sSW.T{5,2}(4,:)/sSW.Mb(cTR,cTR)  ,  -sSW.T{5,4}(4,:)/sSW.Mb(cTR,cTR) ,  sSE.T{5,1}(3,:)/sSE.Mb(cTL,cTL) ,  sSE.T{5,4}(3,:)/sSE.Mb(cTL,cTL)  ,  sparse(1,m)                     , sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  -0.5*sSW.T{5,5}(4,2)/sSW.Mb(cTR,cTR),  -0.5*sSW.T{5,5}(4,3)/sSW.Mb(cTR,cTR)  ,  (1-sSW.T{5,5}(4,4))/sSW.Mb(cTR,cTR)  ,  0.5*sSE.T{5,5}(3,1)/sSE.Mb(cTL,cTL) ,  (-1+sSE.T{5,5}(3,3))/sSE.Mb(cTL,cTL)  ,  0.5*sSE.T{5,5}(3,4)/sSE.Mb(cTL,cTL)  ,  0                                    ,  0                                     ,  0                                    ,  0                                     ,  0                                    ,  0                                   ;
          sparse(1,m)                       ,  sparse(1,m)                      ,  sSE.T{5,1}(1,:)                 ,  sSE.T{5,4}(1,:)                  ,  sparse(1,m)                     , sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  1                                   ,  0                                     ,  0                                    ,  0.5*sSE.T{5,5}(1,1)+0.5             ,  sSE.T{5,5}(1,3)                       ,  0.5*sSE.T{5,5}(1,4)                  ,  0                                    ,  0                                     ,  0                                    ,  0                                     ,  0                                    ,  0                                   ;
          -sSW.T{5,2}(4,:)/sSW.Mb(cTR,cTR)  ,  -sSW.T{5,4}(4,:)/sSW.Mb(cTR,cTR) ,  sparse(1,m)                     ,  sparse(1,m)                      ,  sNW.T{5,2}(2,:)/sNW.Mb(cBR,cBR) , sNW.T{5,3}(2,:)/sNW.Mb(cBR,cBR)  ,  sparse(1,m)                     ,  sparse(1,m)                      ,  -0.5*sSW.T{5,5}(4,2)/sSW.Mb(cTR,cTR),  -0.5*sSW.T{5,5}(4,3)/sSW.Mb(cTR,cTR)  ,  (1-sSW.T{5,5}(4,4))/sSW.Mb(cTR,cTR)  ,  0                                   ,  0                                     ,  0                                    ,  0.5*sNW.T{5,5}(2,1)/sNW.Mb(cBR,cBR)  ,  (-1+sNW.T{5,5}(2,2))/sNW.Mb(cBR,cBR)  ,  0.5*sNW.T{5,5}(2,4)/sNW.Mb(cBR,cBR)  ,  0                                     ,  0                                    ,  0                                   ;
          sparse(1,m)                       ,  sparse(1,m)                      ,  sSE.T{5,1}(4,:)                 ,  sSE.T{5,4}(4,:)                  ,  sparse(1,m)                     , sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  0                                   ,  0                                     ,  0                                    ,  0.5*sSE.T{5,5}(4,1)                 ,  sSE.T{5,5}(4,3)                       ,  0.5*sSE.T{5,5}(4,4)+0.5              ,  0                                    ,  0                                     ,  0                                    ,  0                                     ,  1                                    ,  0                                   ;
          sparse(1,m)                       ,  sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  sNW.T{5,2}(1,:)                 , sNW.T{5,3}(1,:)                  ,  sparse(1,m)                     ,  sparse(1,m)                      ,  0                                   ,  1                                     ,  0                                    ,  0                                   ,  0                                     ,  0                                    ,  0.5*sNW.T{5,5}(1,1)+0.5              ,  sNW.T{5,5}(1,2)                       ,  0.5*sNW.T{5,5}(1,4)                  ,  0                                     ,  0                                    ,  0                                   ;
          -sSW.T{5,2}(4,:)/sSW.Mb(cTR,cTR)  ,  -sSW.T{5,4}(4,:)/sSW.Mb(cTR,cTR) ,  sparse(1,m)                     ,  sparse(1,m)                      ,  sparse(1,m)                     , sparse(1,m)                      ,  sNE.T{5,1}(1,:)/sNE.Mb(cBL,cBL) ,  sNE.T{5,3}(1,:)/sNE.Mb(cBL,cBL)  ,  -0.5*sSW.T{5,5}(4,2)/sSW.Mb(cTR,cTR),  -0.5*sSW.T{5,5}(4,3)/sSW.Mb(cTR,cTR)  ,  (1-sSW.T{5,5}(4,4))/sSW.Mb(cTR,cTR)  ,  0                                   ,  0                                     ,  0                                    ,  0                                    ,  0                                     ,  0                                    ,  (-1+sNE.T{5,5}(1,1))/sNE.Mb(cBL,cBL)  ,  0.5*sNE.T{5,5}(1,2)/sNE.Mb(cBL,cBL)  ,  0.5*sNE.T{5,5}(1,3)/sNE.Mb(cBL,cBL) ;
          sparse(1,m)                       ,  sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  sNW.T{5,2}(4,:)                 , sNW.T{5,3}(4,:)                  ,  sparse(1,m)                     ,  sparse(1,m)                      ,  0                                   ,  0                                     ,  0                                    ,  0                                   ,  0                                     ,  0                                    ,  0.5*sNW.T{5,5}(4,1)                  ,  sNW.T{5,5}(4,2)                       ,  0.5*sNW.T{5,5}(4,4)+0.5              ,  0                                     ,  0                                    ,  1                                   ;
          sSW.T{5,2}(4,:)                   ,  sSW.T{5,4}(4,:)                  ,  sSE.T{5,1}(3,:)                 ,  sSE.T{5,4}(3,:)                  ,  sNW.T{5,2}(2,:)                 , sNW.T{5,3}(2,:)                  ,  sNE.T{5,1}(1,:)                 ,  sNE.T{5,3}(1,:)                  ,  0.5*sSW.T{5,5}(4,2)                 ,  0.5*sSW.T{5,5}(4,3)                   ,  1+sSW.T{5,5}(4,4)                    ,  0.5*sSE.T{5,5}(3,1)                 ,  1+sSE.T{5,5}(3,3)                     ,  0.5*sSE.T{5,5}(3,4)                  ,  0.5*sNW.T{5,5}(2,1)                  ,  1+sNW.T{5,5}(2,2)                     ,  0.5*sNW.T{5,5}(2,4)                  ,  1+sNE.T{5,5}(1,1)                     ,  0.5*sNE.T{5,5}(1,2)                  ,  0.5*sNE.T{5,5}(1,3)                 ;
          sparse(1,m)                       ,  sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  sparse(1,m)                     , sparse(1,m)                      ,  sNE.T{5,1}(2,:)                 ,  sNE.T{5,3}(2,:)                  ,  0                                   ,  0                                     ,  0                                    ,  0                                   ,  0                                     ,  1                                    ,  0                                    ,  0                                     ,  0                                    ,  sNE.T{5,5}(2,1)                       ,  0.5*sNE.T{5,5}(2,2)+0.5              ,  0.5*sNE.T{5,5}(2,3)                 ;
          sparse(1,m)                       ,  sparse(1,m)                      ,  sparse(1,m)                     ,  sparse(1,m)                      ,  sparse(1,m)                     , sparse(1,m)                      ,  sNE.T{5,1}(3,:)                 ,  sNE.T{5,3}(3,:)                  ,  0                                   ,  0                                     ,  0                                    ,  0                                   ,  0                                     ,  0                                    ,  0                                    ,  0                                     ,  1                                    ,  sNE.T{5,5}(3,1)                       ,  0.5*sNE.T{5,5}(3,2)                  ,  0.5*sNE.T{5,5}(3,3)+0.5             ;
        ];
    ...
    ubSE = ([x(2*m+1:3*m); ...
             ...
             0.5*(IBC{2}(sSE.px(sSE.idx_boundary(cBR)),sSE.py(sSE.idx_boundary(cBR)))+IBC{3}(sSE.px(sSE.idx_boundary(cBR)),sSE.py(sSE.idx_boundary(cBR)))); ...
             x(8*m+5); ...
             0.5*IBC{2}(sNE.px(sNE.idx_boundary(cBR)),sNE.py(sNE.idx_boundary(cBR)))+0.5*x(8*m+6)] - ooSE) / (2i * eta);
    ubNW = ([IBC{1}(sNW.px(sNW.idx_left),sNW.py(sNW.idx_left)); ...
             ...
             x(8*m+8); ...
             0.5*(IBC{1}(sNW.px(sNW.idx_boundary(cTL)),sNW.py(sNW.idx_boundary(cTL)))+IBC{4}(sNW.px(sNW.idx_boundary(cTL)),sNW.py(sNW.idx_boundary(cTL)))); ...
             0.5*IBC{4}(sNE.px(sNE.idx_boundary(cTL)),sNE.py(sNE.idx_boundary(cTL)))+0.5*x(8*m+9)] - ooNW) / (2i * eta);
    ubNE = ([x(6*m+1:7*m); ...
             IBC{2}(sNE.px(sNE.idx_right),sNE.py(sNE.idx_right)); ...
             x(7*m+1:8*m); ...
	         IBC{4}(sNE.px(sNE.idx_top),sNE.py(sNE.idx_top)); ...
             x(8*m+10); ...
	         0.5*IBC{2}(sSE.px(sSE.idx_boundary(cTR)),sSE.py(sSE.idx_boundary(cTR)))+0.5*x(8*m+11);...
	         0.5*IBC{4}(sNW.px(sNW.idx_boundary(cTR)),sNW.py(sNW.idx_boundary(cTR)))+0.5*x(8*m+12);...
