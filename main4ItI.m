...
for div = 5:5
    ...
    A = [
        speye(m)                        ,  sparse(m,m)                    ,  sSW.T{2,2}                     ,  sparse(m,m)                    ,  sparse(m,m)                     ,  sSW.T{2,4}                     ,  sparse(m,m)                    ,  sparse(m,m)                    ,  sparse(m,1)                         ,  sparse(m,1)                        ,  sSW.T{2,5}(:,4)                    ,  0.5*sSW.T{2,5}(:,2)               ,  sparse(m,1)                         ,  sparse(m,1)                        ,  0.5*sSW.T{2,5}(:,3)                ,  sparse(m,1)                         ,  sparse(m,1)                         ,  sparse(m,1)                         ,  sparse(m,1)                        ,  sparse(m,1)                        ;
        sparse(m,m)                     ,  speye(m)                       ,  sSW.T{4,2}                     ,  sparse(m,m)                    ,  sparse(m,m)                     ,  sSW.T{4,4}                     ,  sparse(m,m)                    ,  sparse(m,m)                    ,  sparse(m,1)                         ,  sparse(m,1)                        ,  sSW.T{4,5}(:,4)                    ,  0.5*sSW.T{4,5}(:,2)               ,  sparse(m,1)                         ,  sparse(m,1)                        ,  0.5*sSW.T{4,5}(:,3)                ,  sparse(m,1)                         ,  sparse(m,1)                         ,  sparse(m,1)                         ,  sparse(m,1)                        ,  sparse(m,1)                        ;
        sSE.T{1,1}                      ,  sparse(m,m)                    ,  speye(m)                       ,  sparse(m,m)                    ,  sparse(m,m)                     ,  sparse(m,m)                    ,  sparse(m,m)                    ,  sSE.T{1,4}                     ,  0.5*sSE.T{1,5}(:,1)                ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sSE.T{1,5}(:,3)                     ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                         ,  sparse(m,1)                         ,  sparse(m,1)                         ,  0.5*sSE.T{1,5}(:,4)                ,  sparse(m,1)                        ;
        sSE.T{4,1}                      ,  sparse(m,m)                    ,  sparse(m,m)                    ,  speye(m)                       ,  sparse(m,m)                     ,  sparse(m,m)                    ,  sparse(m,m)                    ,  sSE.T{4,4}                     ,  0.5*sSE.T{4,5}(:,1)                ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sSE.T{4,5}(:,3)                     ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                         ,  sparse(m,1)                         ,  sparse(m,1)                         ,  0.5*sSE.T{4,5}(:,4)                ,  sparse(m,1)                        ;
        sparse(m,m)                     ,  sNW.T{2,3}                     ,  sparse(m,m)                    ,  sparse(m,m)                    ,  speye(m)                        ,  sparse(m,m)                    ,  sNW.T{2,2}                     ,  sparse(m,m)                    ,  sparse(m,1)                         ,  0.5*sNW.T{2,5}(:,1)                ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                         ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sNW.T{2,5}(:,2)                     ,  sparse(m,1)                         ,  sparse(m,1)                         ,  sparse(m,1)                        ,  0.5*sNW.T{2,5}(:,4)                ;
        sparse(m,m)                     ,  sNW.T{3,3}                     ,  sparse(m,m)                    ,  sparse(m,m)                    ,  sparse(m,m)                     ,  speye(m)                       ,  sNW.T{3,2}                     ,  sparse(m,m)                    ,  sparse(m,1)                         ,  0.5*sNW.T{3,5}(:,1)                ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                         ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sNW.T{3,5}(:,2)                     ,  sparse(m,1)                         ,  sparse(m,1)                         ,  sparse(m,1)                        ,  0.5*sNW.T{3,5}(:,4)                ;
        sparse(m,m)                     ,  sparse(m,m)                    ,  sparse(m,m)                    ,  sNE.T{1,3}                     ,  sNE.T{1,1}                      ,  sparse(m,m)                    ,  speye(m)                       ,  sparse(m,m)                    ,  sparse(m,1)                         ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                         ,  0.5*sNE.T{1,5}(:,2)                ,  sparse(m,1)                        ,  sparse(m,1)                         ,  0.5*sNE.T{1,5}(:,3)                 ,  sNE.T{1,5}(:,1)                     ,  sparse(m,1)                        ,  sparse(m,1)                        ;
        sparse(m,m)                     ,  sparse(m,m)                    ,  sparse(m,m)                    ,  sNE.T{3,3}                     ,  sNE.T{3,1}                      ,  sparse(m,m)                    ,  sparse(m,m)                    ,  speye(m)                       ,  sparse(m,1)                         ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                        ,  sparse(m,1)                         ,  0.5*sNE.T{3,5}(:,2)                ,  sparse(m,1)                        ,  sparse(m,1)                         ,  0.5*sNE.T{3,5}(:,3)                 ,  sNE.T{3,5}(:,1)                     ,  sparse(m,1)                        ,  sparse(m,1)                        ;
        sparse(1,m)                     ,  sparse(1,m)                    ,  sSW.T{5,2}(2,:)                ,  sparse(1,m)                    ,  sparse(1,m)                     ,  sSW.T{5,4}(2,:)                ,  sparse(1,m)                    ,  sparse(1,m)                    ,  1                                   ,  0                                  ,  sSW.T{5,5}(2,4)                    ,  0.5*sSW.T{5,5}(2,2)+0.5            ,  0                                   ,  0                                  ,  0.5*sSW.T{5,5}(2,3)                ,  0                                   ,  0                                   ,  0                                   ,  0                                  ,  0                                  ;
        sparse(1,m)                     ,  sparse(1,m)                    ,  sSW.T{5,2}(3,:)                ,  sparse(1,m)                    ,  sparse(1,m)                     ,  sSW.T{5,4}(3,:)                ,  sparse(1,m)                    ,  sparse(1,m)                    ,  0                                   ,  1                                  ,  sSW.T{5,5}(3,4)                    ,  0.5*sSW.T{5,5}(3,2)                ,  0                                   ,  0                                  ,  0.5*sSW.T{5,5}(3,3)+0.5            ,  0                                   ,  0                                   ,  0                                   ,  0                                  ,  0                                  ;
        sSE.T{5,1}(3,:)/sSE.Mb(cTL,cTL) ,  sparse(1,m)                    ,  -sSW.T{5,2}(4,:)/sSW.Mb(cTR,cTR),  sparse(1,m)                    ,  sparse(1,m)                     ,  -sSW.T{5,4}(4,:)/sSW.Mb(cTR,cTR),  sparse(1,m)                    ,  sSE.T{5,4}(3,:)/sSE.Mb(cTL,cTL),  0.5*sSE.T{5,5}(3,1)/sSE.Mb(cTL,cTL),  0                                  ,  (1-sSW.T{5,5}(4,4))/sSW.Mb(cTR,cTR),  -0.5*sSW.T{5,5}(4,2)/sSW.Mb(cTR,cTR),  (-1+sSE.T{5,5}(3,3))/sSE.Mb(cTL,cTL),  0                                  ,  -0.5*sSW.T{5,5}(4,3)/sSW.Mb(cTR,cTR),  0                                   ,  0                                   ,  0                                   ,  0.5*sSE.T{5,5}(3,4)/sSE.Mb(cTL,cTL),  0                                  ;
        sSE.T{5,1}(1,:)                 ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sparse(1,m)                     ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sSE.T{5,4}(1,:)                ,  0.5*sSE.T{5,5}(1,1)+0.5            ,  0                                  ,  0                                  ,  1                                  ,  sSE.T{5,5}(1,3)                     ,  0                                  ,  0                                  ,  0                                   ,  0                                   ,  0                                   ,  0.5*sSE.T{5,5}(1,4)                ,  0                                  ;
        sparse(1,m)                     ,  sNW.T{5,3}(2,:)/sNW.Mb(cBR,cBR),  -sSW.T{5,2}(4,:)/sSW.Mb(cTR,cTR),  sparse(1,m)                    ,  sparse(1,m)                     ,  -sSW.T{5,4}(4,:)/sSW.Mb(cTR,cTR),  sNW.T{5,2}(2,:)/sNW.Mb(cBR,cBR),  sparse(1,m)                    ,  0                                   ,  0.5*sNW.T{5,5}(2,1)/sNW.Mb(cBR,cBR),  (1-sSW.T{5,5}(4,4))/sSW.Mb(cTR,cTR),  -0.5*sSW.T{5,5}(4,2)/sSW.Mb(cTR,cTR),  0                                   ,  0                                  ,  -0.5*sSW.T{5,5}(4,3)/sSW.Mb(cTR,cTR),  (-1+sNW.T{5,5}(2,2))/sNW.Mb(cBR,cBR),  0                                   ,  0                                   ,  0                                  ,  0.5*sNW.T{5,5}(2,4)/sNW.Mb(cBR,cBR);
        sSE.T{5,1}(4,:)                 ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sparse(1,m)                     ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sSE.T{5,4}(4,:)                ,  0.5*sSE.T{5,5}(4,1)                ,  0                                  ,  0                                  ,  0                                  ,  sSE.T{5,5}(4,3)                     ,  1                                  ,  0                                  ,  0                                   ,  0                                   ,  0                                   ,  0.5*sSE.T{5,5}(4,4)+0.5            ,  0                                  ;
        sparse(1,m)                     ,  sNW.T{5,3}(1,:)                ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sparse(1,m)                     ,  sparse(1,m)                    ,  sNW.T{5,2}(1,:)                ,  sparse(1,m)                    ,  0                                   ,  0.5*sNW.T{5,5}(1,1)+0.5            ,  0                                  ,  0                                  ,  0                                   ,  0                                  ,  1                                  ,  sNW.T{5,5}(1,2)                     ,  0                                   ,  0                                   ,  0                                  ,  0.5*sNW.T{5,5}(1,4)                ;
        sparse(1,m)                     ,  sparse(1,m)                    ,  -sSW.T{5,2}(4,:)/sSW.Mb(cTR,cTR),  sNE.T{5,3}(1,:)/sNE.Mb(cBL,cBL),  sNE.T{5,1}(1,:)/sNE.Mb(cBL,cBL) ,  -sSW.T{5,4}(4,:)/sSW.Mb(cTR,cTR),  sparse(1,m)                    ,  sparse(1,m)                    ,  0                                   ,  0                                  ,  (1-sSW.T{5,5}(4,4))/sSW.Mb(cTR,cTR),  -0.5*sSW.T{5,5}(4,2)/sSW.Mb(cTR,cTR),  0                                   ,  0.5*sNE.T{5,5}(1,2)/sNE.Mb(cBL,cBL),  -0.5*sSW.T{5,5}(4,3)/sSW.Mb(cTR,cTR),  0                                   ,  0.5*sNE.T{5,5}(1,3)/sNE.Mb(cBL,cBL),  (-1+sNE.T{5,5}(1,1))/sNE.Mb(cBL,cBL),  0                                  ,  0                                  ;
        sparse(1,m)                     ,  sNW.T{5,3}(4,:)                ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sparse(1,m)                     ,  sparse(1,m)                    ,  sNW.T{5,2}(4,:)                ,  sparse(1,m)                    ,  0                                   ,  0.5*sNW.T{5,5}(4,1)                ,  0                                  ,  0                                  ,  0                                   ,  0                                  ,  0                                  ,  sNW.T{5,5}(4,2)                     ,  1                                   ,  0                                   ,  0                                  ,  0.5*sNW.T{5,5}(4,4)+0.5            ;
        sSE.T{5,1}(3,:)                 ,  sNW.T{5,3}(2,:)                ,  sSW.T{5,2}(4,:)                ,  sNE.T{5,3}(1,:)                ,  sNE.T{5,1}(1,:)                 ,  sSW.T{5,4}(4,:)                ,  sNW.T{5,2}(2,:)                ,  sSE.T{5,4}(3,:)                ,  0.5*sSE.T{5,5}(3,1)                ,  0.5*sNW.T{5,5}(2,1)                ,  1+sSW.T{5,5}(4,4)                  ,  0.5*sSW.T{5,5}(4,2)                ,  1+sSE.T{5,5}(3,3)                   ,  0.5*sNE.T{5,5}(1,2)                ,  0.5*sSW.T{5,5}(4,3)                ,  1+sNW.T{5,5}(2,2)                   ,  0.5*sNE.T{5,5}(1,3)                 ,  1+sNE.T{5,5}(1,1)                   ,  0.5*sSE.T{5,5}(3,4)                ,  0.5*sNW.T{5,5}(2,4)                ;
        sparse(1,m)                     ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sNE.T{5,3}(2,:)                ,  sNE.T{5,1}(2,:)                 ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sparse(1,m)                    ,  0                                   ,  0                                  ,  0                                  ,  0                                  ,  0                                   ,  0.5*sNE.T{5,5}(2,2)+0.5            ,  0                                  ,  0                                   ,  0.5*sNE.T{5,5}(2,3)                 ,  sNE.T{5,5}(2,1)                     ,  1                                  ,  0                                  ;
        sparse(1,m)                     ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sNE.T{5,3}(3,:)                ,  sNE.T{5,1}(3,:)                 ,  sparse(1,m)                    ,  sparse(1,m)                    ,  sparse(1,m)                    ,  0                                   ,  0                                  ,  0                                  ,  0                                  ,  0                                   ,  0.5*sNE.T{5,5}(3,2)                ,  0                                  ,  0                                   ,  0.5*sNE.T{5,5}(3,3)+0.5             ,  sNE.T{5,5}(3,1)                     ,  0                                  ,  1                                  ;
        ];
